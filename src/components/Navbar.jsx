        ...
        <div className="flex items-center justify-center md:justify-between max-w-5xl mx-auto px-4 py-3">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button
              type="button"
              onClick={toggleTheme}
              className="h-8 w-8 rounded-full flex items-center justify-center border border-slate-700 bg-slate-900/80 hover:border-sky-400 text-slate-300 hover:text-sky-300 transition"
