        ...
        {selectedSkill && (
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <motion.div
              ...
              className="relative z-50 w-full max-w-lg rounded-2xl border border-sky-500/30 bg-slate-950/95 p-0 shadow-[0_0_50px_rgba(14,165,233,0.3)] overflow-hidden"
            >
              ...
              <div className="p-8 relative z-10">
                ...
                <div className="space-y-6 text-sm text-slate-300 h-auto max-h-[35vh] overflow-y-auto pr-4 custom-scrollbar">
                  <div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedSkill.relatedProjects.map(p => (
                          <a key={p.id} href={`#/projects/${p.id}`} className="flex items-center gap-1.5 px-3 py-1.5 bg-sky-500/5 border border-sky-500/20 rounded-lg hover:border-sky-500/80 hover:bg-sky-500/10 transition-all group">
                ...
                <div className="mt-8 pt-6 border-t border-slate-800/80 flex justify-between items-center">
                  ...
                  <a
                    ...
                    className="px-6 py-2 rounded-lg text-[11px] font-black uppercase tracking-widest bg-sky-500 text-slate-950 hover:bg-[#0A66C2] hover:shadow-[0_0_30px_rgba(14,165,233,0.5)] transition-all flex items-center gap-2"
                  >
