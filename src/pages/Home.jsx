          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="space-y-4">
              ...
              >
                ...
                <h1 className="text-5xl md:text-7xl font-black italic text-slate-100 uppercase tracking-tighter leading-[0.9] mb-6">
                  Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-emerald-400">{hero.name}</span>
                </h1>
                <p className="text-xl md:text-2xl text-slate-200 font-bold max-w-2xl leading-tight">
                  {hero.headline}
                </p>
                <p className="text-slate-400 max-w-2xl leading-relaxed text-base mt-4 border-l-2 border-slate-800 pl-4">
                  {hero.tagline}
                </p>
              </motion.div>
            </div>
